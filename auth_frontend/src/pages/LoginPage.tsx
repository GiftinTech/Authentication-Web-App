        ...
        <div className="absolute right-0 bottom-0 w-full rounded-tr-[150px] bg-white p-10 md:h-[42%] md:rounded-tr-[250px] md:pt-15 lg:static lg:rounded-tr-none lg:p-10 lg:text-left">
          ...
          >
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-2 text-lg font-bold text-gray-700 shadow-sm transition-all duration-300 hover:bg-gray-50"
            >
